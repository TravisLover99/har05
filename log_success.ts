  ...
  try {
    if (req.method === 'GET') {
      ...
      if (worker_id && service && balance) {
        ...
        console.error('[ERROR] Missing required parameters: worker_id, service, balance');
      }
    } else {
